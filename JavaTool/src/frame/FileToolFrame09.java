...
import contllorer.FileToolGUIContllorer09;

public class FileToolFrame09 extends FileToolFrame {

	private JTextField textField;
	private JTextField textField2;
	private JTextField textField3;
	FileToolGUIContllorer GuiCont = new FileToolGUIContllorer09();
	private JTextArea textArea;
	/**
	 * Create the panel.
	 */
	public FileToolFrame09() {
		f.setTitle("3-09_複数のファイルを一つのファイルに結合する");
